...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-06-11 09:43:38',NULL),('diagnostics.include_raw','OFF','2025-06-11 09:43:38',NULL),('ps_thread_trx_info.max_length','65535','2025-06-11 09:43:38',NULL),('statement_performance_analyzer.limit','100','2025-06-11 09:43:38',NULL),('statement_performance_analyzer.view',NULL,'2025-06-11 09:43:38',NULL),('statement_truncate_len','64','2025-06-11 09:43:38',NULL);
...
-- Dump completed on 2025-06-16 16:54:12
-- MySQL dump 10.13  Distrib 8.0.33, for Win64 (x86_64)
--
...
INSERT INTO `consegne` VALUES ('eq_differenziali.txt',9,'Equazioni Differenziali','n4m3b2v!','auroraramaz@unina.it'),('equazioni_differenziali.txt',8,'Equazioni Differenziali','n4m3b2v!','giuliadelellis@unina.it'),('limiti.txt',NULL,'Esercizi Limiti','op3t5p4!','demme33@unina.it'),('es_limiti.txt',NULL,'Esercizi Limiti','op3t5p4!','massimoran@unina.it'),('esercizi_limiti.txt',NULL,'Esercizi Limiti','op3t5p4!','miriamleone@unina.it'),('esonero_fourier.txt',10,'Prova Fourier','o2i3k4j!','diegoarmando@unina.it'),('fourier.txt',6,'Prova Fourier','o2i3k4j!','gerryscotti@unina.it'),('laplace.txt',4,'Prova Laplace','o2i3k4j!','biancolino@unina.it'),('esonero.txt',10,'Prova Laplace','o2i3k4j!','diegoarmando@unina.it'),('laplace.txt',1,'Prova Laplace','o2i3k4j!','gerryscotti@unina.it'),('es_laplace.txt',7,'Prova Laplace','o2i3k4j!','gianlucagrign@unina.it'),('esonero_residui.txt',10,'Prova Residui','o2i3k4j!','diegoarmando@unina.it'),('es_residui.txt',4,'Prova Residui','o2i3k4j!','gerryscotti@unina.it'),('sequence.txt',5,'Sequence Diagram','i8k6j5h!','antoniocol1@unina.it'),('sd.txt',5,'Sequence Diagram','i8k6j5h!','federicanargi@unina.it'),('sequence_diagram.txt',2,'Sequence Diagram','i8k6j5h!','geolier1@unina.it'),('seq_diagr.txt',4,'Sequence Diagram','i8k6j5h!','gianlucagaetano@unina.it'),('simulazione.txt',30,'Simulazione Esame','u6j5o34!','mariannaarfe@unina.it'),('simulazione_thread.txt',30,'Simulazione Esame 2','u6j5o34!','mariannaarfe@unina.it');
...
INSERT INTO `task` VALUES ('Equazioni Differenziali','Svolgere almeno due dei tre esercizi sulle equazioni differenziali','2025-09-01',9,'n4m3b2v!'),('Esercizi Limiti','Svolgere almeno due dei tre esercizi proposti per poter ottenere la sufficienza','2025-07-01',9,'op3t5p4!'),('Matlab','Consegnare lo script di matlab degli esercizi riguardanti i controllori dinamici','2025-10-11',13,'v3c4n5m!'),('Prova Fourier','Completare la prova assegnata per essere esonerati dallo svolgimento dell\'esercizio su Fourier all\'esame','2025-06-25',10,'o2i3k4j!'),('Prova Laplace','Completare la prova assegnata per essere esonerati dallo svolgimento dell\'esercizio su Laplace all\'esame','2025-06-15',10,'o2i3k4j!'),('Prova Residui','Completare la prova assegnata per essere esonerati dallo svolgimento dell\'esercizio sui residui all\'esame','2025-06-30',10,'o2i3k4j!'),('Sequence Diagram','Sviluppare il sequence diagram del caso d\'uso allegato alla prova','2025-06-17',5,'i8k6j5h!'),('Simulazione Esame','File da completare: header.h, main.c, client.c, server.c','2025-07-12',30,'u6j5o34!'),('Simulazione Esame 2','Esercitazione sui thread. Da completare: header.h, main.c, client.c, server.c','2025-08-01',30,'u6j5o34!');
...
-- Dump completed on 2025-06-16 16:54:13
