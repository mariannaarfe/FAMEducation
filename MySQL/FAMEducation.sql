...
CREATE TABLE IF NOT EXISTS `mydb`.`Task` (
  ...
  INDEX `fk_Task_ClassiVirtuali_idx` (`ClassiVirtuali_CodiceUnivoco` ASC) INVISIBLE,
...
INSERT INTO `mydb`.`Docenti` (`Email`, `Nome`, `Cognome`, `Ruolo`, `Password`) VALUES ('stefanodemartino@unina.it', 'Stefano', 'De Martino', 'Docente', 'emmamarrone1!');
...
INSERT INTO `mydb`.`ClassiVirtuali` (`CodiceUnivoco`, `Nome`, `Docenti_Email`) VALUES ('v3c4n5m6', 'Controlli Automatici', 'stefanodemartino@unina.it');
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Task` (`Titolo`, `Descrizione`, `Scadenza`, `MaxPuntiAssegnabili`, `ClassiVirtuali_CodiceUnivoco`, `Docenti_Email`) VALUES ('Esercizi Limiti', 'Svolgere almeno due dei tre esercizi proposti per poter ottenere la sufficienza', '2025-07-01', 9, 'op3t5p4i', 'martinpalumbo@unina.it');
INSERT INTO `mydb`.`Task` (`Titolo`, `Descrizione`, `Scadenza`, `MaxPuntiAssegnabili`, `ClassiVirtuali_CodiceUnivoco`, `Docenti_Email`) VALUES ('Prova Laplace', 'Completare la prova assegnata per essere esonerati dallo svolgimento dell\'esercizio su Laplace all\'esame', '2025-06-15', 10, 'o2i3k4j5', 'francol@unina.it');
INSERT INTO `mydb`.`Task` (`Titolo`, `Descrizione`, `Scadenza`, `MaxPuntiAssegnabili`, `ClassiVirtuali_CodiceUnivoco`, `Docenti_Email`) VALUES ('Simulazione Esame', 'File da completare: header.h, main.c, client.c, server.c', '2025-07-12', 30, 'u6j5o34k', 'antonioconte@unina.it');
INSERT INTO `mydb`.`Task` (`Titolo`, `Descrizione`, `Scadenza`, `MaxPuntiAssegnabili`, `ClassiVirtuali_CodiceUnivoco`, `Docenti_Email`) VALUES ('Sequence Diagram', 'Sviluppare il sequence diagram del caso d\'uso allegato alla prova', '2025-06-17', 5, 'i8k6j5h4', 'pablopicasso@unina.it');
INSERT INTO `mydb`.`Task` (`Titolo`, `Descrizione`, `Scadenza`, `MaxPuntiAssegnabili`, `ClassiVirtuali_CodiceUnivoco`, `Docenti_Email`) VALUES ('Equazioni Differenziali', 'Svolgere almeno due dei tre esercizi sulle equazioni differenziali', '2025-09-01', 9, 'n4m3b2v1', 'martinpalumbo@unina.it');
INSERT INTO `mydb`.`Task` (`Titolo`, `Descrizione`, `Scadenza`, `MaxPuntiAssegnabili`, `ClassiVirtuali_CodiceUnivoco`, `Docenti_Email`) VALUES ('Matlab', 'Consegnare lo script di matlab degli esercizi riguardanti i controllori dinamici', '2025-10-11', 13, '', 'stefanodemartino@unina.it');
INSERT INTO `mydb`.`Task` (`Titolo`, `Descrizione`, `Scadenza`, `MaxPuntiAssegnabili`, `ClassiVirtuali_CodiceUnivoco`, `Docenti_Email`) VALUES ('Simulazione Esame 2', 'Esercitazione sui thread. Da completare: header.h, main.c, client.c, server.c', '2025-08-01', 30, 'u6j5o34k', 'antonioconte@unina.it');
INSERT INTO `mydb`.`Task` (`Titolo`, `Descrizione`, `Scadenza`, `MaxPuntiAssegnabili`, `ClassiVirtuali_CodiceUnivoco`, `Docenti_Email`) VALUES ('Prova Fourier', 'Completare la prova assegnata per essere esonerati dallo svolgimento dell\'esercizio su Fourier all\'esame', '2025-06-25', 10, 'o2i3k4j5', 'francol@unina.it');
INSERT INTO `mydb`.`Task` (`Titolo`, `Descrizione`, `Scadenza`, `MaxPuntiAssegnabili`, `ClassiVirtuali_CodiceUnivoco`, `Docenti_Email`) VALUES ('Prova Residui', 'Completare la prova assegnata per essere esonerati dallo svolgimento dell\'esercizio sui residui all\'esame', '2025-06-30', 10, 'o2i3k4j5', 'francol@unina.it');
